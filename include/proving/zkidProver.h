...
class zkidProver{
    public:
        ...
        const bool GenerateProof(const std::string& credential,const std::string& issuer_address, const std::string& range_low, 
            const std::string& range_high, const std::string& k_factor,VerificationProof& proof);
    private:
